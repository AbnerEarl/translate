wm.javadoc = {
	...
	default:{
		domain:'http://localhost:8060',	//默认的domain域名
		token:''	//默认的token
	},
	domain:{
		set: function(text){
...
//加载必要的js文件
wm.load.synchronizesLoadJs('./msg.js');
wm.load.synchronizesLoadJs('./request.js');
wm.load.synchronizesLoadJs('./jquery-2.1.4.js');
