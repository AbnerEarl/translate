 ...
 * @author Frank
 */
public class TCDN_AutoPublish extends com.xnx3.autoPublish.AutoPublish{
	
	public static void main(String[] args) {
		
		/***** 服务器账号密码 *****/
		SERVER_HOST = "43.156.28.11";  //服务器ip
		SERVER_USERNAME = "root";		 //服务器ssh登录账号
		SERVER_PASSWORD = "1111";//服务器ssh登录密码
		
		//不杀死所有结束java进程
		SHELL_KILL_JAVA = null;
		//设置启动关闭tomcat
		SHELL_SHUTDOWN_TOMCAT = "/mnt/service/bin/shutdown.sh";
		SHELL_START_TOMCAT = "/mnt/service/bin/startup.sh";
		//设置应用所在
		WEBAPPS_PATH = "/mnt/service/webapps/ROOT";
